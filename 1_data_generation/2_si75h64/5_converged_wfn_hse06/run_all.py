...
for step in range(istep, fstep):
    ...
    params.update({"functional_names": ["HYB_GGA_XC_HSE06"]})
    params.update({"functional_keys":  [["SCALE", "_OMEGA_HF", "_OMEGA_PBE"]]})
    params.update({"functional_key_vals":[[1.0, 0.11, 0.11]]})
