...
c = {"element": "C", "basis_set":"ORB SZV-MOLOPT-GTH", "potential":"GTH-BLYP-q4", "fit_basis_set":"cFIT3" }
...
params = {"input_filename":"", "charge":charge, "multiplicity":1, "uks":".FALSE.",
         ...
         "HF_exchange": True, "eps_schwarz": "1.0E-10", "interaction_potential": False, "interaction_potential_type": "SHORTRANGE", 
         "admm_calculations": True, "omega":0.0, "HF_exchange_fraction": 0.2,
...
#    os.system(F'rm coord-{step}.xyz {project}_{step}.inp {project}_{step}-RESTART.wfn.bak-1 \n') 
